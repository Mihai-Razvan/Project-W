...
public class Outline : MonoBehaviour {
  ...
  private Mode outlineMode = Mode.OutlineVisible;    //I changed this in code so don't need to apply the script to anything to make the changes
    ...
    public Color outlineColor = new Color(8, 4, 0);   //I changed; the brighter the color the bigger the glow effect. Idk why, just put a darker color to get rid of glow  //21
